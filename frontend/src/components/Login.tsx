    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-amber-200">
            <h2 className="text-xl font-bold text-amber-800 mb-4">Configuração Necessária</h2>
            <p className="text-gray-700 text-sm">
              Para usar este aplicativo, você precisa configurar as variáveis de ambiente do Supabase.
              Acesse as configurações do projeto e adicione:
            </p>
            <ul className="list-disc pl-5 mt-2 text-sm text-gray-600 font-mono">
    ...
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#F1F5F9] font-sans overflow-hidden">
      <div className="hidden md:flex w-[400px] lg:w-[500px] bg-[#1E293B] p-12 flex-col justify-between text-white relative overflow-hidden shrink-0">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-lg leading-relaxed">Acompanhe o desempenho de seus alunos em tempo real com integração nativa ao Supabase para dados seguros e rápidos.</p>
        </div>
        ...
        <div className="relative z-10">
          <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700 backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider text-slate-300">Status do Banco</span>
            </div>
            <p className="text-sm text-slate-400">Conectado ao <span className="text-white font-medium">Supabase</span></p>
          </div>
        </div>
      </div>
        ...
        <main className="flex-1 flex items-center justify-center p-6 sm:p-12">
          <div className="w-full max-w-[440px]">
            <div className="mb-10">
              ...
              <p className="text-slate-500">{isSignUp ? 'Crie sua conta para gerenciar turmas e notas.' : 'Insira suas credenciais para gerenciar turmas e notas.'}</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleAuth}>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  {!isSignUp && <a href="#" className="text-xs text-blue-600 font-medium hover:underline">Esqueceu a senha?</a>}
                </div>
                <input
                  id="password"
                  name="password"
            ...
            <div className="mt-8 pt-8 border-t border-slate-200">
              ...
              <button
                ...
                className="w-full py-2.5 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors text-sm font-semibold text-slate-700"
              >
